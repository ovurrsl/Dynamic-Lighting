...
export const SECTIONS: readonly Section[] = [
  ...
  { id: 'strips', group: 'setup', titleKey: 'nav.strips', descriptionKey: 'nav.strips.description', glyph: '⧉' },
  ...
  { id: 'picture', group: 'setup', titleKey: 'nav.picture', descriptionKey: 'nav.picture.description', glyph: '◐' },
