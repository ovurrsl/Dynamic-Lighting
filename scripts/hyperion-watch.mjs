 ...
 */
const AREAS = [
  { prefix: 'libsrc/leddevice/dev_serial', area: 'Seri LED cihazları', ours: 'lib/engine/protocol.ts, extension/src/serial.ts' },
  { prefix: 'libsrc/leddevice/dev_net', area: 'Ağ LED cihazları', ours: 'yok — yol haritası 3 (WLED)' },
  ...
  { prefix: 'libsrc/leddevice', area: 'LED cihaz altyapısı', ours: 'lib/engine/link.ts' },
  ...
  { prefix: 'libsrc/grabber', area: 'Yakalama', ours: 'extension/src/capture.ts' },
  { prefix: 'libsrc/effectengine', area: 'Efektler', ours: 'yok — yol haritası 1' },
  { prefix: 'effects', area: 'Efekt tanımları', ours: 'yok — yol haritası 1' },
  { prefix: 'libsrc/api', area: 'API', ours: 'lib/extension/messages.ts' },
  { prefix: 'libsrc/events', area: 'Olaylar', ours: 'yok — yol haritası 7' },
